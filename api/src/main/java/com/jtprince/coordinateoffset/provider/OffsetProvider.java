...
public abstract class OffsetProvider {
     ...
     *
     * <p>Note that this method is <b>only</b> called if the target player's previous offset was generated by this
     * offset provider. A single command may target multiple players, in which case this callback will be executed once
     * for each targeted player. Avoid using {@link OffsetSetCommand#getTargets} in this callback because some targeted
     * players may have an active offset that was created by another provider.</p>
     *
     * @param command Container for information about this offset change. Also contains methods which can be used to
