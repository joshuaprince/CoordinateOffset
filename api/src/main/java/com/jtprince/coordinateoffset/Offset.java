...
public sealed interface Offset permits FixedOffset, ScalableOffset {
     ...
     *         <code>16*(2^p)</code>.
     * @deprecated Alignment is now a server configuration, <code>offsetsAreMultiplesOfBlocks</code>. Use
     * {@link #align(int, int)} instead for automatic alignment based on the configured value.
     */
    @Deprecated(forRemoval = true)
     ...
     * <code>offsetsAreMultiplesOfBlocks</code>. Use {@link #random(int)} instead for automatic alignment based on
